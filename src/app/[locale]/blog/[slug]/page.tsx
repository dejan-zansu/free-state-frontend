  ...
  return (
    <>
      ...
      <div className="bg-[#062E25]">
        <div
          className={`max-w-[1310px] mx-auto px-4 sm:px-6 pt-32 ${
            post.coverImageUrl ? 'pb-44 lg:pb-56' : 'pb-16 lg:pb-20'
          }`}
        >
          <Link
            href={`/${locale}/blog`}
      ...
      >
        {post.coverImageUrl && (
          <div className="max-w-[1310px] mx-auto px-4 sm:px-6">
            <div className="relative h-72 md:h-[520px] rounded-[20px] overflow-hidden -mt-28 lg:-mt-36">
              <Image
