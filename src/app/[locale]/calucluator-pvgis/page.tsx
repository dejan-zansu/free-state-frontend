...
const steps = [
  ...
  { id: 3, title: 'Building', description: 'Building details' },
  { id: 4, title: 'Panels', description: 'Select solar panels' },
  { id: 5, title: 'Placement', description: 'Configure placement' },
  { id: 6, title: 'Inverter', description: 'Select inverter' },
  { id: 7, title: 'Parameters', description: 'Additional info' },
  { id: 8, title: 'Results', description: 'Your solar system' },
]
