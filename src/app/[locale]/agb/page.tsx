...
const AGBPage = async () => {
  ...
  const sections = [
    {
      title: t('scope.title'),
      content: t('scope.content'),
    },
    {
      title: t('contractConclusion.title'),
    ...
    },
    {
      ...
      content: t('dataProtection.content'),
    },
    {
      title: t('applicableLaw.title'),
      content: t('applicableLaw.content'),
    },
    {
      title: t('finalProvisions.title'),
      content: t('finalProvisions.content'),
    },
  ]
