...
import Step1PackageSelection from './steps/Step1PackageSelection'
import Step2BuildingType from './steps/Step1BuildingType'
import Step3HouseholdSize from './steps/Step2HouseholdSize'
import Step4Devices from './steps/Step3Devices'
import Step5RoofAreas from './steps/Step4RoofAreas'
import Step6RoofCovering from './steps/Step5RoofCovering'
import Step7ContactDetails from './steps/Step6ContactDetails'
...
export default function SolarAboCalculatorPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <Step2BuildingType />
      case 3:
        return <Step3HouseholdSize />
      case 4:
        return <Step4Devices />
      case 5:
        return <Step5RoofAreas />
      case 6:
        return <Step6RoofCovering />
      case 7:
        return <Step7ContactDetails />
      default:
        return <Step1PackageSelection />
    }
  }
