...
export default function SonnendachStep4Consumption() {
  ...
  const calculations = useMemo(() => {
    ...
    const estimatedConsumption =
      baseConsumption +
      evConsumption +
      heatPumpHotWaterConsumption +
      heatPumpHeatingConsumption
    const annualConsumption =
      consumption.annualConsumptionKwh || estimatedConsumption
    ...
    if (consumption.heatPumpHeating) selfConsumptionRate += 0.1
    if (consumption.evChargingStations > 0)
      selfConsumptionRate += 0.05 * consumption.evChargingStations
    ...
    const electricityTariff = consumption.electricityTariffAuto
      ? 25
      : consumption.electricityTariff
    const feedInTariff = consumption.feedInTariffAuto
      ? 12
      : consumption.feedInTariff
    ...
    const taxBenefits = Math.round((investment - federalSubsidy) * 0.2)
    ...
    const annualReturnRate =
      netInvestment > 0 ? (annualYield / netInvestment) * 100 : 0
  ...
  }, [consumption, selectedPotentialKwh, selectedPanel, panelCount])
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="propertyType">
                      <SelectValue
                        placeholder={t('propertyInfo.selectPropertyType')}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="residential">
                        {t('propertyInfo.types.residential')}
                      </SelectItem>
                      <SelectItem value="commercial">
                        {t('propertyInfo.types.commercial')}
                      </SelectItem>
                      <SelectItem value="industrial">
                        {t('propertyInfo.types.industrial')}
                      </SelectItem>
                      <SelectItem value="agricultural">
                        {t('propertyInfo.types.agricultural')}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                {/* New Building */}
                <div className="space-y-2">
                  <Label htmlFor="isNewBuilding">
                    {t('propertyInfo.newBuilding')}
                  </Label>
                  <Select
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setConsumption({ evChargingStations: Number(value) })
                    }
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setConsumption({ heatPumpHotWater: value === 'yes' })
                    }
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setConsumption({ heatPumpHeating: value === 'yes' })
                    }
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setConsumption({ electricityProvider: value })
                    }
                  >
                    <SelectTrigger id="electricityProvider">
                      <SelectValue
                        placeholder={t('propertyInfo.selectProvider')}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="standard">
                        {t('propertyInfo.providers.standard')}
                      </SelectItem>
                      <SelectItem value="ewz">
                        {t('propertyInfo.providers.ewz')}
                      </SelectItem>
                      <SelectItem value="axpo">
                        {t('propertyInfo.providers.axpo')}
                      </SelectItem>
                      <SelectItem value="bkw">
                        {t('propertyInfo.providers.bkw')}
                      </SelectItem>
                      <SelectItem value="other">
                        {t('propertyInfo.providers.other')}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={value =>
                      setConsumption({ residents: Number(value) })
                    }
                  >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onChange={e =>
                        setConsumption({
                          annualElectricityCost: Number(e.target.value) || 0,
                        })
                      }
                      className="pr-16"
                    />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {/* Electricity Tariff */}
                <div className="space-y-2">
                  <Label htmlFor="electricityTariff">
                    {t('tariffs.electricityTariff')}
                  </Label>
                  <div className="flex gap-2">
                    <Select
                      value={
                        consumption.electricityTariffAuto ? 'auto' : 'manual'
                      }
                      onValueChange={value =>
                        setConsumption({
                          electricityTariffAuto: value === 'auto',
                        })
                      }
                    >
                    ...
                    <div className="relative bg-muted/30 rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-3 gap-4 items-center mb-4">
                          ...
                          <TooltipTrigger asChild>
                            <div className="bg-blue-100 border-2 border-blue-400 rounded-lg p-3 text-center cursor-help">
                              ...
                              <p className="text-lg font-bold text-blue-600">
                                {formatSwissNumber(
                                  calculations.annualConsumption
                                )}{' '}
                                kWh
                              </p>
                            </div>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>
                              {t('reports.energyFlow.selfConsumptionTooltip')}
                            </p>
                          </TooltipContent>
                        </Tooltip>
                          ...
                          <TooltipTrigger asChild>
                            <div className="text-center cursor-help">
                              ...
                              <p className="text-xl font-bold">
                                {formatSwissNumber(calculations.gridPurchase)}{' '}
                                kWh
                              </p>
                            </div>
                          </TooltipTrigger>
                        ...
                        <TooltipTrigger asChild>
                          <div className="p-4 border-b cursor-help">
                            ...
                            <p className="text-xl font-bold text-green-600">
                              {formatSwissNumber(
                                calculations.grossReturnOverLifetime
                              )}{' '}
                              CHF
                            </p>
                          </div>
                        ...
                        <TooltipTrigger asChild>
                          <div className="p-4 border-b cursor-help">
                            ...
                            <p className="text-xl font-bold text-blue-600">
                              {formatSwissNumber(calculations.totalSubsidies)}{' '}
                              CHF
                            </p>
                          </div>
                        </TooltipTrigger>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="p-4 cursor-help">
                            ...
                            <p className="text-xl font-bold">
                              {formatSwissNumber(calculations.netInvestment)}{' '}
                              CHF
                            </p>
                          </div>
                        </TooltipTrigger>
                ...
                <CardContent>
                  <div className="h-[280px]">
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <RechartsTooltip
                          formatter={value => [
                            `${formatSwissNumber(Number(value) || 0)} CHF`,
                            t('reports.roiChart.cumulative'),
                          ]}
                          labelFormatter={label =>
                            `${t('reports.roiChart.year')} ${label}`
                          }
                        />
                        <ReferenceLine
                          y={0}
                  ...
                  {paybackYear && (
                    <p className="text-sm text-center text-muted-foreground mt-2">
                      {t('reports.roiChart.paybackInfo', {
                        years: paybackYear,
                      })}
                    </p>
                  )}
                        ...
                        <RechartsTooltip
                          formatter={(value, name) => {
                            const labels: Record<string, string> = {
                              ...
                              consumption: t(
                                'reports.monthlyChart.consumption'
                              ),
                              selfConsumption: t(
                                'reports.monthlyChart.selfConsumption'
                              ),
                            }
                            return [
                              `${formatSwissNumber(Number(value) || 0)} kWh`,
