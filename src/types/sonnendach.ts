...
// Suitability class mapping (BFE Sonnendach: klasse 1=low ... 5=excellent)
export const SUITABILITY_CLASSES: Record<number, SuitabilityInfo> = {
  1: { class: 1, label: 'low', labelDe: 'gering', color: '#3B82F6' },
  2: { class: 2, label: 'medium', labelDe: 'mittel', color: '#22C55E' },
  3: { class: 3, label: 'good', labelDe: 'gut', color: '#EAB308' },
  4: { class: 4, label: 'very good', labelDe: 'sehr gut', color: '#F97316' },
  5: {
    class: 5,
    label: 'excellent',
