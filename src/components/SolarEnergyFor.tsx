          ...
          <div className='relative'>
            ...
            <div className='relative z-10 px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-10'>
              <div className='mb-6 sm:mb-8'>
                ...
                <p className='text-white/80 font-light max-w-2xl mx-auto leading-5 sm:leading-6 text-sm sm:text-base'>
                  {t('description')}
                </p>
              </div>
              ...
              <div className='flex flex-col sm:flex-row gap-4 sm:gap-6'>
                {items.map((item, index) => (
                  <div key={index} className='flex-1'>
                    <h3 className='text-white text-xl sm:text-2xl font-semibold mb-2 sm:mb-3 flex items-center gap-2 sm:gap-2.5'>
                      <MinimalLogoIcon className='w-5 h-5 sm:w-6 sm:h-6 shrink-0 text-[#9F3E4F]' />
                      {item.title}
                    </h3>
                    <p className='text-white/80 font-light italic leading-5 sm:leading-6 text-sm sm:text-base'>
                      {item.description}
                    </p>
                  </div>
                ))}
