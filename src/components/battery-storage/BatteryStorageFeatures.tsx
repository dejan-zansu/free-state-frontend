...
const BatteryStorageFeatures = async () => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 items-stretch">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative aspect-[4/3] lg:aspect-auto lg:h-full w-full rounded-xl overflow-hidden">
              <Image
                src="/images/battery-storage/batteries.png"
...
export default BatteryStorageFeatures
