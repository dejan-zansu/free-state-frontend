    ...
    <section className="relative w-full overflow-hidden pt-12 lg:pt-[50px]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 w-full">
        {members.map(member => (
          <div
            key={member.key}
            className="group relative h-[400px] sm:h-[550px] lg:h-[734px] border-[0.5px] border-[#F2F4E8]/50 overflow-hidden"
          >
            <div
            ...
            <div className="relative h-full">
              ...
              {member.image && (
                <div className="absolute bottom-5 left-1/2 -translate-x-1/2 flex items-center gap-2.5 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <button className="inline-flex items-center justify-center px-4 py-2.5 rounded-[20px] border border-white/30 bg-white/30 backdrop-blur-[65px] text-white text-base font-normal tracking-tight whitespace-nowrap cursor-pointer hover:bg-white/50 transition-colors">
                    E-mail
                  </button>
                  <button className="inline-flex items-center justify-center px-4 py-2.5 rounded-[20px] border border-white/30 bg-white/30 backdrop-blur-[65px] text-white text-base font-normal tracking-tight whitespace-nowrap cursor-pointer hover:bg-white/50 transition-colors">
                    Telefon
