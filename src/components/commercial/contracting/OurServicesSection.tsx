  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            'url(/images/commercial/contracting/our-services-bg-15cd4e.png)',
      ...
      <div className="relative z-10 mx-auto flex w-full flex-col items-center gap-[50px] px-4 py-12 sm:px-6 lg:max-w-[571px] lg:px-0 lg:py-[50px]">
