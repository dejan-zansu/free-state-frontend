    ...
    <section className="relative">
      <div className="flex flex-col lg:flex-row">
          ...
          <div className="max-w-[461px] mx-auto flex flex-col gap-5 py-12 lg:py-0 px-4 sm:px-6 lg:px-0">
            ...
            <div className="flex flex-col gap-[10px]">
              <div className="flex flex-row gap-[8px] items-center">
                <div className="w-[18px] h-[18px] flex items-center justify-center rounded-[9px] border-[1.5px] border-[#9F3E4F] shrink-0">
        ...
        <div className="w-full lg:w-1/2 relative aspect-[720/487]">
          <Image
            src="/images/bidirectional-charging-station/types-of-bidirectional-charging-commercial.png"
