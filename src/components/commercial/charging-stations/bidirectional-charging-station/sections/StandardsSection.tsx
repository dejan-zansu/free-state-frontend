...
const StandardsSection = async () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(7deg, rgba(59, 46, 88, 1) 0%, rgba(49, 39, 73, 1) 21%, rgba(86, 73, 112, 1) 100%)',
      }}
    >
      <div
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
