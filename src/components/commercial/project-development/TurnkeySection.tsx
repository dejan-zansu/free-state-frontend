...
const items = ['approval', 'construction', 'commissioning'] as const

const TurnkeySection = async () => {
  ...
  return (
    <section className="relative">
      <div className="flex flex-col lg:flex-row">
        ...
        >
          <div className="flex flex-col gap-5 lg:pl-[70px] max-w-[561px]">
            <div
