...
const SolarPanelWorksSection = async () => {
  ...
  return (
    <section className="relative min-h-[507px] flex flex-col items-center justify-center overflow-hidden">
      <Image
        src="/images/commercial/how-large-plants-works/solar-panel-works-bg-241c1c.png"
        alt=""
        fill
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(0deg, rgba(61, 56, 88, 0) 0%, rgba(79, 74, 109, 1) 67%)',
        }}
      />
      <div
        className="absolute inset-0"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-[90px]">
          ...
          <div className="flex items-center gap-[13px]">
            ...
            <div
              className="rounded-[20px] px-8 py-5 max-w-[443px]"
              style={{
...
export default SolarPanelWorksSection
