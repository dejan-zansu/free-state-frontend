...
const InRoofOnRoofSection = async () => {
  ...
  return (
    <section className="relative">
      <div className="flex flex-col lg:flex-row">
        ...
        >
          <div className="max-w-[556px] flex flex-col gap-5 lg:pl-[69px]">
            <h2 className="text-[#062E25] text-3xl sm:text-4xl md:text-[45px] font-medium">
              {t('inRoofOnRoof.title')}
            </h2>
            <p className="text-[#062E25]/80 text-lg md:text-[22px] font-medium tracking-[-0.02em] whitespace-pre-line">
              {t('inRoofOnRoof.description')}
            </p>
          </div>
        </div>
...
export default InRoofOnRoofSection
