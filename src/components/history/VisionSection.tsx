...
const VisionSection = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto relative flex flex-col lg:flex-row min-h-[500px] lg:min-h-[731px]">
        ...
        <div className="relative lg:absolute lg:right-0 lg:top-0 lg:w-1/2 h-[300px] sm:h-[400px] lg:h-full flex items-center justify-center px-4 sm:px-6 lg:px-10 py-8">
          <Image
          ...
          <div className="relative z-20 w-full max-w-[577px] p-6 sm:p-10 rounded-[16px] border border-[#f6f6f6]/60 backdrop-blur-[10px] bg-[rgba(28,40,31,0.06)]">
