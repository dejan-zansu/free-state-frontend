    ...
    <section className='relative py-16 sm:pt-16 bg-white overflow-visible'>
      <div className='max-w-[1440px] mx-auto px-4 sm:px-6'>
        ...
        <div className='relative w-full max-w-[1440px] mx-auto'>
          {/* Dashed Grid - Desktop */}
          <div className='hidden lg:block relative w-full aspect-[10/3] min-h-[400px]' style={{ overflow: 'visible' }}>
            ...
            >
              ...
              {/* Cross marks at all intersections */}
              <rect width='100%' height='100%' fill='url(#gridCrosses)' />
              {/* Ensure bottom line is visible */}
              <line x1='0' y1='100%' x2='100%' y2='100%' stroke='#D1D5DB' strokeWidth='1.5' strokeDasharray='8 4' />
