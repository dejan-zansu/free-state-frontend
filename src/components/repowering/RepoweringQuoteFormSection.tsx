  ...
  if (status === 'success') {
    return (
      <section
        ...
        style={{
          background:
            'linear-gradient(180deg, rgba(243, 245, 233, 1) 50%, rgba(220, 233, 230, 1) 100%)',
        }}
      >
      ...
      <div className="max-w-[1038px] mx-auto px-4 sm:px-6 py-12 md:py-[50px]">
        <div className="flex flex-col items-center gap-[50px]">
          ...
          <form
            ...
            className="w-full max-w-[621px] flex flex-col gap-5"
          >
              ...
              <label className="flex items-center gap-[10px] cursor-pointer">
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setFormData({
                      ...formData,
                      callbackRequested: checked as boolean,
                    })
                  }
