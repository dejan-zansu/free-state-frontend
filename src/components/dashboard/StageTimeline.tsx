  ...
  return (
    <section className="rounded-2xl border border-pine/10 bg-white p-6 sm:p-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-pine/75">{t('subtitle')}</p>
      </div>
            ...
            <li key={milestone.stage} className="relative flex gap-4">
              ...
              <span
                className={cn(
                  ...
                  !isDone &&
                    !isActive &&
                    'border-pine/20 bg-white text-pine/75'
                )}
              >
                {isDone ? (
              ...
              <div className="flex-1 pb-1">
                <div className="flex flex-wrap items-center gap-2">
                  <h3
                    className={cn(
                      ...
                      isActive || isDone ? 'text-pine' : 'text-pine/75'
                    )}
                  >
                  ...
                  <span
                    className={cn(
                      ...
                      !isDone && !isActive && 'bg-pine/5 text-pine/75'
                    )}
                  >
                    {isDone
                      ? t('statusDone')
                ...
                {milestone.note && (
                  <p className="mt-2 rounded-lg bg-sage px-3 py-2 text-sm text-pine">
                    {milestone.note}
                  </p>
                )}
              </div>
