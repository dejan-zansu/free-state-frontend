              ...
              <div className="grid">
                ...
                >
                  <div className="flex flex-col min-w-[200px] pt-3">
                    <div className="flex items-center gap-1.5 text-white text-sm sm:text-base font-medium whitespace-nowrap mb-[30px]">
                    ...
                    {solarAboLinks.map((link, index) => (
                      <Link
                        ...
                        href={link.href}
                        className={cn(
                          'py-[7px] text-white text-sm sm:text-base font-light border-b border-white/60 hover:border-white transition-all duration-400 whitespace-nowrap',
                          displayItem === 'solarAbo' && hasDropdown
                    ...
                    {productLinks.map((product, columnIndex) => {
                      ...
                      return (
                        ...
                        >
                          <Link
                            href={product.href}
                            className="flex items-center gap-1.5 text-white text-sm sm:text-base font-medium hover:opacity-80 transition-opacity whitespace-nowrap mb-[30px]"
                          >
                            <Icon
