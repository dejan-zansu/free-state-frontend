...
const VehicleListSection = async ({ headerClassName, headerTextClassName }: VehicleListSectionProps) => {
    ...
    >
      <div className="max-w-[1440px] w-full mx-auto">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-1/2 px-4 sm:px-6 lg:px-16 relative">
            <Image
              src="/images/bidirectional-charging/list-of-vehicles.png"
              alt=""
              fill
              className="object-cover hidden lg:block"
            />
            <div className="max-w-[643px] mx-auto flex flex-col gap-[20px] relative z-10">
          ...
          <div className="lg:w-1/2 px-4 sm:px-6 lg:px-8 mt-8 lg:mt-0">
            <div className="w-full overflow-x-auto">
              <div className="min-w-[500px]">
                <div className={`grid grid-cols-3 border border-[#062E25]/40 rounded-t-2xl backdrop-blur-[20px] ${headerClassName}`}>
                  <span className={`px-[17px] py-3 text-lg font-semibold tracking-[-0.02em] ${headerTextClassName}`}>
                    {t('vehicleList.headers.makeModel')}
                  </span>
                  <span className={`px-5 py-3 text-lg font-semibold tracking-[-0.02em] border-dashed border-l border-[#8BA192] ${headerTextClassName}`}>
