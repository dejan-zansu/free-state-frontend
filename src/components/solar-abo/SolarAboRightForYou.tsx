...
const SolarAboRightForYou = async ({
  ...
  const idealFor = [
    t('rightForYou.idealFor.singleFamily'),
    t('rightForYou.idealFor.predictableCosts'),
    t('rightForYou.idealFor.noUpfront'),
    t('rightForYou.idealFor.noMaintenance'),
  ]

  const notIdealFor = [
    t('rightForYou.notIdealFor.batteryStorage'),
    t('rightForYou.notIdealFor.commercial'),
  ]
...
export default SolarAboRightForYou
