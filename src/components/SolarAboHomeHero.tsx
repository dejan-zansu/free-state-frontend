...
const SolarAboHomeHero = async ({ 
  imageSrc = '/images/solar-abo-home-graphic.png',
  ...
  return (
    <section className='relative flex flex-col items-center justify-center overflow-hidden bg-white'>
          ...
          <div className='flex flex-col sm:flex-row gap-6'>
            ...
            <div className='flex-1 space-y-6'>
              <div className='flex items-center gap-4'>
                <div className='w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shrink-0'>
                  <DollarSign className='w-6 h-6 sm:w-8 sm:h-8 text-[#062E25]' strokeWidth={1.5} />
                </div>
              ...
              <div className='flex items-center gap-4'>
                <div className='w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shrink-0'>
                  <TrendingDown className='w-6 h-6 sm:w-8 sm:h-8 text-[#062E25]' strokeWidth={1.5} />
                </div>
                <p className='text-[#062E25]/80 text-base sm:text-lg font-medium leading-[1.09em] whitespace-pre-line'>
                  {t('stats.left.electricity')}
                </p>
            ...
            <div className='flex-1 space-y-6'>
              <div className='flex items-center gap-4 flex-row-reverse sm:flex-row'>
                <div className='w-12 h-12 sm:w-16 sm:h-16 flex items-center justify-center shrink-0'>
                  <Settings className='w-6 h-6 sm:w-8 sm:h-8 text-[#062E25]' strokeWidth={1.5} />
                </div>
