      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-xl bg-[#F5F7EE] p-4">
            <p className="text-base text-[#062E25]">{t('systemSize')}</p>
          ...
          <div className="rounded-xl bg-[#F5F7EE] p-4">
            <p className="text-base text-[#062E25]">{t('annualProduction')}</p>
            <p className="text-2xl font-bold text-[#062E25] tabular-nums">
          ...
          <div className="rounded-xl bg-[#F5F7EE] p-4">
            <p className="text-base text-[#062E25]">{t('co2Offset')}</p>
            <p className="text-2xl font-bold text-[#062E25] tabular-nums">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
          <div>
            <p className="text-base text-[#062E25]">{t('selfConsumption')}</p>
            <p className="text-xl font-semibold text-[#062E25] tabular-nums">
              {selfConsumptionPct != null ? `${selfConsumptionPct}%` : '-'}
            </p>
          </div>
          <div>
            <p className="text-base text-[#062E25]">{t('annualConsumption')}</p>
            <p className="text-xl font-semibold text-[#062E25] tabular-nums">
          ...
          <div>
            <p className="text-base text-[#062E25]">{t('ppaDiscount')}</p>
            <p className="text-xl font-semibold text-[#062E25] tabular-nums">
          ...
          <div>
            <p className="text-base text-[#062E25]">{t('recommendedPackage')}</p>
