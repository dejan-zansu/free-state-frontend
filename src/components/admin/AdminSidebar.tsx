  ...
  const navGroups: { label?: string; items: NavItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: t('outreachLinkedin'),
          href: `${prefix}/outreach/linkedin`,
          icon: Linkedin,
          capability: 'sales.tools',
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: t('marketingLive'),
          href: `${prefix}/marketing/analytics/live`,
          icon: Radio,
          capability: 'users.manage',
        },
        {
          label: t('marketingCalculator'),
          href: `${prefix}/marketing/analytics/calculator`,
          icon: Gauge,
          capability: 'users.manage',
        },
        {
