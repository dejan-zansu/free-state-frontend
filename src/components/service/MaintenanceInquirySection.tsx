...
const MaintenanceInquirySection = () => {
  ...
  if (status === 'success') {
    return (
      <section
        className="relative w-full pt-20 pb-[120px]"
        style={{
          background:
            'linear-gradient(180deg, rgba(242, 244, 232, 1) 84%, rgba(220, 233, 230, 1) 100%)',
        }}
      >
  ...
  return (
    ...
    >
      <div className="max-w-[621px] mx-auto px-4 sm:px-6 pt-12 md:pt-[50px] pb-[calc(48px+40px)] md:pb-[calc(50px+40px)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[29px]">
                  ...
                  >
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        setFormData({
                          ...formData,
                          maintenanceServices: toggleArrayItem(
              ...
              <div className="flex flex-col gap-[7px]">
                <label className="flex items-center gap-[10px] cursor-pointer">
                  <input
                    ...
                    onChange={() =>
                      setFormData({ ...formData, hasFreeStateSystem: true })
                    }
                ...
                <label className="flex items-center gap-[10px] cursor-pointer">
                  <input
                    ...
                    onChange={() =>
                      setFormData({ ...formData, hasFreeStateSystem: false })
                    }
                    className="size-[15px] accent-[#4A9A99] opacity-60"
                  />
                  <span className="text-[#062E25]/60 text-sm font-medium tracking-[-0.02em]">
            ...
            <div className="flex flex-col gap-[5px]">
              ...
              <Input
                ...
                onChange={e =>
                  setFormData({ ...formData, systemOutputKwp: e.target.value })
                }
            ...
            <div className="flex flex-col gap-[5px]">
              ...
              <Select
                ...
                onValueChange={value =>
                  setFormData({ ...formData, hasInternetAccess: value })
                }
              >
                <SelectTrigger className="h-9 bg-[#EAEDDF] border-[#E5E5E5] rounded-[5px] backdrop-blur-[65px] text-[#062E25] text-sm font-medium tracking-[-0.02em]">
                  <SelectValue placeholder={t('internetAccess.placeholder')} />
                </SelectTrigger>
                <SelectContent position="popper">
                  <SelectItem value="yes">
                    {t('internetOptions.yes')}
                  </SelectItem>
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-col gap-[5px]">
                ...
                <Textarea
                  ...
                  className="min-h-[120px] bg-[#EAEDDF] border-[#E5E5E5] rounded-[5px] backdrop-blur-[65px] text-[#062E25] placeholder:text-[#062E25]/20 text-sm font-medium tracking-[-0.02em] resize-none"
                />
              </div>
              ...
              <label className="flex items-center gap-[10px] cursor-pointer">
                <Checkbox
                  ...
                  onCheckedChange={checked =>
                    setFormData({
                      ...formData,
                      consentPrivacy: checked as boolean,
                    })
                  }
