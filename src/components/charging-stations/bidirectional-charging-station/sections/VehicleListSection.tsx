          ...
          <div className="lg:w-1/2 px-4 sm:px-6 lg:px-8 mt-8 lg:mt-0">
            <div className="w-full overflow-x-auto">
              <div className="min-w-[500px]">
                <div className="grid grid-cols-3 bg-[#B7FE1A] border border-[#062E25]/40 rounded-t-2xl backdrop-blur-[20px]">
                  <span className="px-[17px] py-3 text-[#062E25]/80 text-lg font-semibold tracking-[-0.02em]">
                    {t('vehicleList.headers.makeModel')}
                  </span>
                  <span className="px-5 py-3 text-[#062E25]/80 text-lg font-semibold tracking-[-0.02em] border-dashed border-l border-[#8BA192]">
