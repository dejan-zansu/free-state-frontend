...
interface MarketingFlexibilitySectionBaseProps {
  glowColor: string
  glowLeft: string
  glowTop: string
...
const MarketingFlexibilitySectionBase = async ({
  glowColor,
  glowLeft,
  glowTop,
  cardBackground,
}: MarketingFlexibilitySectionBaseProps) => {
      ...
      <div className="max-w-[867px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-[50px]">
          ...
          <div className="flex flex-col sm:flex-row gap-[20px] max-w-[740px] mx-auto">
            <div
              className="border border-[#809792] rounded-[20px] w-[360px] h-[317px] relative overflow-hidden"
...
export default MarketingFlexibilitySectionBase
