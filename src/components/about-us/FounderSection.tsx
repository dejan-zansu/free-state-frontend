...
const FounderSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full -mt-[69px] rounded-t-[40px] overflow-hidden border border-[#63836F] min-h-[500px] sm:min-h-[600px] lg:min-h-[820px]">
        <Image
        ...
        <div className="relative z-20 flex justify-center pt-[86px] pb-12 sm:pb-16 px-4">
          <div className="w-full max-w-[720px] flex flex-col items-center text-center p-6 sm:p-10 rounded-[16px] border border-[#f6f6f6]/60 backdrop-blur-[10px] bg-[rgba(185,205,191,0.03)]">
