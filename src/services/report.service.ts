...
class ReportService {
  async downloadSonnendachReport(
    params: SonnendachReportParams
  ): Promise<void> {
    console.log(
      '[ReportService] Starting API call to /reports/sonnendach-report'
    )
    console.log('[ReportService] Params:', {
